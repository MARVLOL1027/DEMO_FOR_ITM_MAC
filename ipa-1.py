...
def savings(gross_pay, tax_rate, expenses):
    ...
    amt_of_savings = after_tax - expenses
    return amt_of_savings
...
def material_waste(total_material, material_units, num_jobs, job_consumption):
    ...
    material_waste_without_units = total_material - total_material_consumed 
    material_waste = str(material_waste_without_units) + material_units
...
def interest(principal, rate, periods):
    ...
    output = int(principal + interest_earned)
    return output
...
def body_mass_index(weight, height):
    ...
    height_from_ft = 0.3048 * height[0]
    height_from_inch = 0.0254 * height[1]
    height_m = height_from_ft + height_from_inch
